...
export default function Navbar() {
	...
	const navigations = (
		<>
			...
			<Link href="/wishlist" className="block hover:text-pink-500 no-underline hover:underline">
				Wishlist
			</Link>
		</>
	);
		...
		<nav className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
			<div className="relative flex justify-center items-center h-16">
				...
				<button
					...
					className="bg-white absolute right-4 md:hidden focus:outline-none transition"
				>
					<svg
						className="w-7 h-7"
						fill="none"
